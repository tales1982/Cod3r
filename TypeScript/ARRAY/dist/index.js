...
for (let i = 0; i < 5; i++) {
    ...
    //4°
    let liguangens = new Array("JavaScript", "Golang", "C", "Java", "TypeScript");
    function lerLinguagens(liguangens) {
